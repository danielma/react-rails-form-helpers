...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckBoxTag = exports.CheckBoxTag = function CheckBoxTag(_ref) {
	  ...
	  return React.createElement(
	    "span",
	    null,
	    React.createElement(HiddenFieldTag, { value: uncheckedValue }),
	    React.createElement("input", _extends({ type: "checkbox" }, propsWithDefault))
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nameWithContext = exports.nameWithContext = function nameWithContext(Lower) {
	  ...
	  var higher = function higher(props, context) {
	    ...
	    var replacedProps = _extends({}, props, _defineProperty({}, prop, replacedProp));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HiddenField = exports.HiddenField = (0, _utils.nameWithContext)(Tags.HiddenFieldTag);
	...
	var DestroyField = exports.DestroyField = function DestroyField() {
	  return React.createElement(HiddenField, { name: "_destroy", value: "1" });
	};
